...
CRITICAL_MIN_COOLDOWN_MINUTES = 10    # Absolute non-bypassable minimum even for critical opportunities
...
EPSILON_DECAY_RATE = 0.985 # Multiplicative decay applied after each completed RL episode
